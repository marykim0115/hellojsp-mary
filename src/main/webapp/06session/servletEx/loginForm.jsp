...
<head>
<meta charset="UTF-8">
<title>서블릿으로 로그인하기-연습</title>
</head>
<body>
<h2>서블릿으로 로그인하기-연습</h2>

<%
	//로그인 실패시 출력될 화면(loginController 서블릿에서 쿼리스트링으로 파라미터 값과 함께 넘어옴)
...
%>
	...
	<form action="loginProcess" method="post" name="loginFrm">
        ...
        비밀번호 : <input type="password" name="user_pw" value="1234" required="required"/><br />
